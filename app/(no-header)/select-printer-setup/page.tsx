...
export default function SelectPrinterSoftware() {
  ...
  const benefitsListOne = [
    "Installing drivers or software incorrectly",
    "Unreliable wireless or defective USB connection",
    "Missing software updates or outdated firmware",
    "Inaccurate configuration during setup",
    "Problems with your computer's operating system compatibility",
    "Internal printer malfunctions or hardware problems",
  ];
    ...
    <div className="w-full font-sans antialiased text-slate-800 bg-white relative">
      ...
      <section className="py-16 px-6 md:px-12 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
        ...
        <div className="lg:col-span-6 space-y-6">
          <h2 className="text-3xl md:text-4xl font-bold text-[#1762c0] tracking-tight">
            Why Is Your Printer Configuration Failing?
          </h2>
          <p className="text-slate-900 text-sm md:text-lg leading-relaxed">
            Printer setup issues are more common than you might imagine, and
            once you figure out what's wrong, they're typically simple to
            resolve. Here are a few common explanations:
          </p>
      ...
      <section className="py-16 px-6 md:px-12 max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-12 items-center border-t border-slate-100">
        ...
        <div className="lg:col-span-6 order-2 lg:order-1 bg-[#F8FAFC] border border-slate-200/80 rounded-xl p-4 shadow-sm">
          <img src="/printersetup2.jpg" alt="" />
        </div>

        {/* Right Side Text Block Panel Content */}
        <div className="lg:col-span-6 order-1 lg:order-2 space-y-4">
          <h2 className="text-3xl md:text-4xl font-bold text-[#1762c0] tracking-tight">
            Start Fixing Your Printer Configuration Issue
          </h2>
          <div className="space-y-4 text-slate-900 text-xs md:text-lg leading-relaxed font-normal">
            <p>
              Are you experiencing hardware issues, software installation
              issues, or printer connection issues? We can assist you in getting
              back on track with our comprehensive troubleshooting guide.
            </p>
            <p>
              Compatible with the majority of well-known brands, such as
              Brother, Epson, HP, Canon, and others.
            </p>
            <p>
