...
const SchematicOverlay = () => (
  ...
  >
    ...
    <rect
      width="100%"
      height="100%"
      fill="url(#contactGrid)"
      className="text-slate-900"
    />
    {/* Abstract circuit vector nodes */}
    <path
      d="M100,80 L180,80 L220,120 L220,200"
      fill="none"
      stroke="currentColor"
      strokeWidth="1.5"
      className="text-[#1464D8] opacity-20"
    />
    <path
      d="M800,400 L850,450 L950,450"
      fill="none"
      stroke="currentColor"
      strokeWidth="1.5"
    ...
    <div className="w-full bg-white text-slate-700 min-h-screen font-sans selection:bg-blue-500 selection:text-white relative overflow-hidden">
      ...
      <section className="relative pt-15 pb-12 px-6 max-w-7xl mx-auto">
        ...
        <div className="text-center max-w-3xl mx-auto space-y-6">
          ...
          >
            Have questions about device drivers, updates, or compatibility? Our
            team is here to help you understand the basics and stay informed
            about your hardware.
          </motion.p>
        </div>
      </section>
          ...
          <div className="lg:col-span-5 space-y-10">
            <div className="space-y-4">
              ...
              <p className="text-slate-500 font-light text-sm leading-relaxed max-w-md">
                Whether you're looking for information about a specific driver
                or want to share feedback about our content, we're ready to
                connect with you.
              </p>
            </div>
            ...
            <div className="space-y-4 max-w-md">
              <div className="group flex items-start gap-4 p-5 bg-slate-50/50 border border-slate-100 hover:border-blue-100 rounded-2xl shadow-xs hover:shadow-md transition-all duration-300">
                ...
                <div className="space-y-1">
                  ...
                  <a
                    href="mailto:info@madaboutdrivers.shop"
                    className="text-sm font-semibold text-slate-800 hover:text-[#1464D8] transition-colors break-all"
                  >
                    info@allaboutdriver
                  </a>
                </div>
              ...
              <div className="group relative overflow-hidden flex items-start gap-4 p-5 rounded-2xl border border-indigo-100 bg-gradient-to-br from-indigo-50 via-white to-violet-50 shadow-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1">
                {/* Glow */}
                <div className="absolute -top-10 -right-10 h-24 w-24 rounded-full bg-indigo-200/40 blur-3xl group-hover:bg-indigo-300/50 transition-all" />

                {/* Icon */}
                <div className="relative w-14 h-14 rounded-2xl bg-gradient-to-br from-indigo-600 to-violet-600 flex items-center justify-center text-white shadow-lg shrink-0">
                  <Bot size={24} />
                </div>
                ...
                <div className="relative flex-1">
                  ...
                  <p className="text-sm text-slate-600 leading-relaxed">
                    Instant troubleshooting, printer setup, error diagnosis and
                    support—
                  ...
                  <button onClick={openChat} className="mt-3 text-sm font-semibold text-indigo-600 hover:text-indigo-700 flex items-center gap-1">
                    Chat with Us
                    <ArrowRight
                      size={16}
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      >
                        ...
                        <option value="Update Awareness">
                          Update Awareness
                        </option>
                        <option value="Compatibility Questions">
        ...
        <div className="bg-slate-200/60 border border-slate-300 rounded-3xl p-8 md:p-12 flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="space-y-2 text-center md:text-left">
            ...
            <p className="text-slate-500 font-light text-sm max-w-xl">
              Check out our latest blog posts for more information on drivers,
              system metrics, and hardware support.
            </p>
          </div>
