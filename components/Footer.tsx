...
function Footer() {
  return (
    <footer className="w-full bg-blue-900 text-slate-200 py-16 px-6 border-t border-slate-800">
        <div className="max-w-7xl mx-auto grid md:grid-cols-12 gap-12 mb-12">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <ul className="space-y-2 text-sm font-light">
              ...
              <li><a href="#" className="hover:text-white transition-colors">Latest Blogs</a></li>
          ...
          <div className="md:col-span-4 space-y-4">
            ...
            <button className="mt-2 px-6 py-2 rounded-full border border-slate-700 text-white text-xs font-medium hover:border-white transition-colors">
              Get in Touch
            </button>
          </div>
        </div>
        <div className="max-w-7xl mx-auto border-t border-slate-800/60 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs font-light">
